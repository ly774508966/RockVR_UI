...
namespace WanzyeeStudio.Json{
	...
	/// <summary>
	/// <c>Newtonsoft.Json.JsonConverter</c> for <c>UnityEngine.Vector3</c>.
	/// </summary>
	public class Vector3Converter : JsonConverter{
		...
		/// <summary>
		/// Determine if the type is <c>UnityEngine.Vector3</c>.
		/// </summary>
