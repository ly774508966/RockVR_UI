...
namespace WanzyeeStudio.Json{
	...
	public class BoundsConverter : JsonConverter{
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer){
			...
			var _s = new JsonSerializer();
			_s.Converters.Add(new Vector3Converter());

			var _v = (Bounds)value;
			var _o = new JObject();

			_o["center"] = JToken.FromObject(_v.center, _s);
			_o["extents"] = JToken.FromObject(_v.extents, _s);
